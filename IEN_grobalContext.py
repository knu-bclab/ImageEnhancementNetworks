...
class Generator(nn.Module):
    def __init__(self ,residualFactor):
        ...
        self.L1_4 = conv_S(3, 16, 4, 4, 0)      # 8x8
        self.L1_2 = conv_S(3, 16, 2, 2, 0)      # 16x16

        self.L6d = conv_B_E(32, 16, 16, 3, 1, 1) # 1x1
        self.L5d = conv_B_E(48, 16, 16, 3, 1, 1) # 2x2
        self.L4d = conv_B_E(48, 16, 16, 3, 1, 1) # 4x4
        self.L3d = conv_B_E(48, 16, 16, 3, 1, 1) # 8x8
        self.L2d = conv_B_E(48, 16, 16, 3, 1, 1) # 16x16
    ...
    def forward(self, img):
        ...
        out_L1_32 = self.L1_32(img_i) # 1x1
        out_L1_16 = self.L1_16(img_i) # 2x2
        out_L1_8 = self.L1_8(img_i)   # 4x4
